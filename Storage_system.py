...
with open('Balance.txt', mode='r') as file_stream:
    account = file_stream.read()
    account = float(account)
with open('History_overview.txt', mode='r') as file_stream:
    history_file = file_stream.read()
...
with open("Balance.txt", mode="w") as file_stream:
    balance_file = file_stream.write(f'{account}')
